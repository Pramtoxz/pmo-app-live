        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.shops.update', $shop->kd_toko) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kd_toko" 
                                           value="{{ $shop->kd_toko }}" disabled>
                                    <small class="text-muted">Kode toko tidak dapat diubah</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('toko') is-invalid @enderror" 
                                           id="toko" name="toko" value="{{ old('toko', $shop->toko) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_telp') is-invalid @enderror" 
                                           id="no_telp" name="no_telp" value="{{ old('no_telp', $shop->no_telp) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('npwp') is-invalid @enderror" 
                                           id="npwp" name="npwp" value="{{ old('npwp', $shop->npwp) }}" 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                              ...
                                              placeholder="Alamat lengkap toko">{{ old('alamat', $shop->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kategori') is-invalid @enderror" 
                                           id="kategori" name="kategori" value="{{ old('kategori', $shop->kategori) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kd_ahm') is-invalid @enderror" 
                                           id="kd_ahm" name="kd_ahm" value="{{ old('kd_ahm', $shop->kd_ahm) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="toko_active" 
                                               name="toko_active" {{ old('toko_active', $shop->toko_active) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="toko_active">
                                            <strong>Toko Aktif</strong>
                                            <small class="text-muted d-block">Nonaktifkan toko jika tidak ingin menghapus data</small>
                                        </label>
                                    </div>
                                </div>
                            </div>
